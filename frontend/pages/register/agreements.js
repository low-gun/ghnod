...
export default function AgreementsPage() {
  ...
  // 전체 동의 체크박스 로직
  useEffect(() => {
    if (termsChecked && privacyChecked && marketingChecked) setAllChecked(true);
  ...
  // 동의 후 뒤로가기
  const handleAgree = () => {
    // 실제 서비스에서는 동의값을 상태/스토리지/context/zustand 등으로 전달 필요
      ...
      <div className="agreements-list">
        <section>
          <label className="agree-label">
            ...
            />
            <b>이용약관 <span className="required">(필수)</span></b>
          </label>
        ...
        <section>
          <label className="agree-label">
            <input
              ...
              className="agree-item-checkbox"
            />
            <b>개인정보 수집 및 이용 <span className="required">(필수)</span></b>
          </label>
        ...
        <section>
          <label className="agree-label">
            <input
              ...
              className="agree-item-checkbox"
            />
            <b>마케팅 정보 수신 동의 <span className="optional">(선택)</span></b>
          </label>
